              ...
              qa_checks: [
                {
                  name: "ui-smoke",
                  status: "pass",
                  summary: "UI smoke passed under executable QA.",
                  command: "bun test",
                  exit_code: 0,
                  observed_output: "ui smoke passed",
                  probe_type: "adversarial",
                  evidence_refs: ["snapshots/main-flow.json"],
                },
              ],
            },
          },
              ...
              qa_checks: [
                {
                  ...
                  status: "pass",
                  summary: "Plan contract tests passed under executable QA.",
                  command: "bun test plan_contract_tests",
                  exit_code: 0,
                  observed_output: "plan_contract_tests passed",
                  probe_type: "adversarial",
                  evidence_refs: ["artifacts/plan_contract_tests.txt"],
                },
              ],
            },
          },
              ...
              qa_checks: [
                {
                  ...
                  observed_output: "ui smoke passed",
                  probe_type: "adversarial",
                  evidence_refs: ["artifacts/ui-smoke.txt"],
                },
              ],
            },
          },
