...
- `docs/research/promoted/rfc-answer-presentation-policy-and-tui-diagram-rendering.md`
...
- `docs/research/promoted/rfc-canonical-hosted-turn-envelope.md`
...
- `docs/research/promoted/rfc-interactive-prompt-queue-and-pending-strip.md`
...
- `docs/research/promoted/rfc-kimi-code-token-cache-adapter.md`
