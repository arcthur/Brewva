...
export const SCAN_CONVERGENCE_TOOL_RULES_BY_NAME = {
  ...
  browser_open: staticRule("progress"),
  browser_wait: staticRule("progress"),
  browser_snapshot: staticRule("evidence_reuse"),
  browser_click: staticRule("progress"),
  browser_fill: staticRule("progress"),
  browser_get: staticRule("evidence_reuse"),
  browser_screenshot: staticRule("evidence_reuse"),
  browser_pdf: staticRule("evidence_reuse"),
  browser_diff_snapshot: staticRule("evidence_reuse"),
  browser_state_load: staticRule("progress"),
  browser_state_save: staticRule("progress"),
  browser_close: staticRule("progress"),
  tape_handoff: staticRule("progress"),
  worker_results_merge: staticRule("progress"),
  worker_results_apply: staticRule("progress"),
  subagent_run: staticRule("progress"),
  subagent_fanout: staticRule("progress"),
  subagent_status: staticRule("progress"),
  subagent_cancel: staticRule("progress"),
